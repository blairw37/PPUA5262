...
avg_price_per_sq_ft_df_filtered2<-avg_price_per_sq_ft_df %>% filter(CT_ID_10_SUB=="120600") %>% select(CT_ID_10_SUB,LISTING_DATE,AVG_PRICE_PER_SQ_FT)
```
